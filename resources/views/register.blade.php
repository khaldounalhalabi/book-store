...
<main dir="rtl" lang="ar" class="segoui">
    <div id="login-form-wrap" class="transparent">
        ...
        <form id="login-form" action="{{route('customer.doRegister')}}" method="POST">
            ...
            <p>
                <input class="form-control border-dark" type="email" id="email" name="email" placeholder="البريد الاكتروني" required><i
                    class="validation"><span></span><span></span></i>
            </p>
            <p>
                <input class="form-control border-dark" type="password" id="password" name="password" placeholder="كلمة السر" required><i
                    class="validation"><span></span><span></span></i>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline datepicker">
                        <input type="text" class="form-control border-dark bg-transparent" id="door_number" name="post_code"
            ...
            <p>
                <input type="submit" id="register" value="التسجيل" class="segoui" name="register">
            </p>
        </form>
