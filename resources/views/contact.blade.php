                ...
                <div class="col-md-6 p-0 mb-3">
                    ...
                    <div class="contact-detail d-flex flex-wrap mt-4">
                        <div class="detail mr-6 mb-4">
                            <p>We'd love to hear from you! If you have any questions or feedback about our products or services, please don't hesitate to get in touch. You can reach us by phone, email, or through the contact form on this page.
                                Our customer support team is available to assist you with any issues or concerns you may have. We strive to provide the best possible service to our customers and are committed to resolving any problems as quickly and efficiently as possible.
                ...
                <div class="col-md-6 p-0">
                    ...
                    <div class="contact-information">
                        ...
                        <form name="contactform" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" minlength="2" name="name" placeholder="الاسم" class="u-full-width"
                                           required>
                                </div>
                                <div class="col-md-6">
                                    <input type="email" name="email" placeholder="البريد الالكتروني" class="u-full-width" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="u-full-width" name="message" placeholder="الرسالة"
