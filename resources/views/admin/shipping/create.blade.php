            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h1 class="card-title text-primary" style="font-family: 'Segoe UI',sans-serif">إضافة دولة</h1>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                            <div class="card p-1">
                        ...
                        <form id="serviceForm" action="{{ route('admin.shipping.store') }}" method="post"
                            ...
                            <div class="row m-auto">
                                ...
                                <div class="col-md-12  m-auto">
                                    ...
                                    <input id="shipping_cost" name="shipping_cost" type="number" step="any" class="form-control"
