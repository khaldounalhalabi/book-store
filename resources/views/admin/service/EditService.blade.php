...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit the service with the title ({{ $service->title }})</h5>
                    @include('admin.include.error')
                    <form id="serviceForm" action="{{ route('admin.service.doEdit' , ['id' => $service->id]) }}" method="post"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="short_description" name="short_description" form="serviceForm"
                                    class="form-control"
                                    style="height: 100px">{{ $service->short_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea dir="rtl" id="arabic_short_description" name="arabic_short_description"
                                    ...
                                    style="height: 100px"> {{ $service->arabic_short_description }} </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="long_description_image" id="long_description_image" class="form-control"
                                    type="file" value="{{ $service->long_description_image }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="long_description_sub_image" id="long_description_sub_image"
                                    class="form-control" type="file" value="{{ $service->long_description_sub_image }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="long_description_title_color" id="title_color" type="color"
                                    ...
                                    title="Choose your color" value="{{ $service->long_description_title_color }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="long_description" name="long_description" form="serviceForm"
                                    class="form-control" style="height: 100px">{{ $service->long_description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="arabic_long_description" name="arabic_long_description" form="serviceForm"
                                    class="form-control"
                                    style="height: 100px">{{ $service->arabic_long_description }}</textarea>
                            </div>
                        </div>
